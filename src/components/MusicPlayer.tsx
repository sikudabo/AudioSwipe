...
const RacheeseAlmbumCover = require('../album-cover-media/racheesecover.jpeg')
        ...
        >
          ...
          >
            {paused ? (
              ...
              <PauseRounded sx={{ fontSize: '3rem' }} htmlColor={mainIconColor} onClick={handlePause} />
            )}
          </IconButton>
